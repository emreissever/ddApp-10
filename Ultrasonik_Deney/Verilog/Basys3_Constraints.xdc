...
#Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {us_echo_pin}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {us_echo_pin}]
#Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {us_trig_pin}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {us_trig_pin}]
